    ...
    return function(ai_type, _, _)
        ...
        for i = 1, #matched_ranges - 1 do
            ...
            if ai_type == "i" then
                ret[i] = {
                    ...
                    to = { line = next_row-1, col = #vim.api.nvim_buf_get_lines(0, next_row-2, next_row-1, false)[1] + 1 },
                }
            elseif ai_type == "a" then
                ret[i] = {
                    from = { line = cur_row, col = 1 },
                    to = { line = next_row, col = #vim.api.nvim_buf_get_lines(0, next_row-1, next_row, false)[1] + 1 },
                }
            end
        end
        ...
        if ai_type == "i" then
            ...
            ret[#ret + 1] = {
                ...
                to = { line = last_line, col = #vim.api.nvim_buf_get_lines(0, last_line - 1, last_line, false)[1] + 1 },
            }
        elseif ai_type == "a" then
            local last_row = matched_ranges[#matched_ranges][1] + 1
            ret[#ret + 1] = {
