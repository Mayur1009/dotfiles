...
return {
    {
        ...
        config = function()
            ...
            vim.keymap.set("n", "<M-m><M-m>", function()
                vim.api.nvim_feedkeys(vim.api.nvim_replace_termcodes("vio<M-m><esc>", true, false, true), "m", false)
            end, { desc = "Run cell and goto next" })
            ...
            vim.api.nvim_create_autocmd("LspAttach", {
                group = augroup("molten_otter"),
                pattern = { "*.ipynb" },
                callback = function(_)
                    require("otter").activate()
                    vim.notify("Otter activated for this notebook")
                end,
            })
